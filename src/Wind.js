...
function(app, Backbone, $, TweenMax2, Snowflake) {
	var self,
	SnowView = Backbone.View.extend({
		...
		initialize: function() {
			...
			// Snow Look
			this.snowAmount = 150; // The number of snowflakes
		...
		_createBackground: function() {
			$('body > div.container').after($('<div/>', {id: "background"}));
			this._resizeBackground();
			$('#background').css({opacity: 1});
/*
			TweenMax.to('#background', 2.2, {
				opacity: 1,
...
*/
		...
		_createCanvas: function() {
			...
			$('body > div.container').after(canvas);
